...
import { findChunkWithName, findAssetWithName } from "./bundle-utils";
...
function generateShell(bundle, templatePath) {
  ...
  return ejs.render(template, {
    bundleFile: findChunkWithName(bundle, "/main/bootstrap.tsx").fileName,
    workerFile: findChunkWithName(bundle, "/worker/index.ts").fileName,
    bundleDeps: findChunkWithName(bundle, "/main/bootstrap.tsx").imports,
    fonts: [
      {
